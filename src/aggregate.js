...
function renderReportMd(report) {
  ...
  rows.push('');
  rows.push('---');
  rows.push(`<sub>Generated by [AragSoft Security](https://github.com/amixiid/aragsoft-security) v${cfg.version} · Score ${report.score}/100</sub>`);
...
${repoRows || '<tr><td colspan="3" class="muted">No repository data.</td></tr>'}
  ...
  <footer>Generated by <a href="https://github.com/amixiid/aragsoft-security">AragSoft Security</a> v${esc(cfg.version)} · ${esc(cfg.runId)}</footer>
</div>
</body>
</html>
`;
